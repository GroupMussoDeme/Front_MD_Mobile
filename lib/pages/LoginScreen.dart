...
const String ASSET_IMAGE_PATH = 'assets/images/background4.png';
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  // 6. Icône d'enregistrement vocal (Microphone)
                  _buildMicIcon(),
                ],
              ),
            ),
  ...
  return Card(
    ...
    child: ClipRRect( // Utilisez ClipRRect pour s'assurer que l'image est bien arrondie
      ...
      child: SizedBox(
        ...
        // --- REMPLACEMENT DU CODE DE SIMULATION PAR L'IMAGE RÉELLE ---
        child: Image.asset(
          ASSET_IMAGE_PATH,
          fit: BoxFit.cover, // Assurez-vous que l'image couvre bien la zone
          // Si l'image ne charge pas, vous pouvez ajouter un placeholder ou une gestion d'erreur :
          errorBuilder: (context, error, stackTrace) {
