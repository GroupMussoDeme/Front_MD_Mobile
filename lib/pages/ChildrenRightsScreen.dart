...
// *****************************************************************
// 1. Composant réutilisable pour un élément de chapitre audio
// *****************************************************************
// (Réutilisation du composant AudioChapterItem de l'écran précédent)
...
class ChildrenRightsScreen extends StatefulWidget {
  const ChildrenRightsScreen({super.key});

  @override
  State<ChildrenRightsScreen> createState() => _ChildrenRightsScreenState();
}

class _ChildrenRightsScreenState extends State<ChildrenRightsScreen> {
  // Simuler le statut de lecture global
  bool _isGlobalAudioPlaying = true; 
  // Simuler le chapitre en cours de lecture
  int _currentPlayingIndex = 2; // Index 2 correspond à "Eviter la mal nutrition enfantine"

  // Liste des chapitres (adaptée pour les Droits des enfants)
  final List<Map<String, dynamic>> _chapters = [
    {'title': 'Droit de l\'enfant', 'icon': Icons.table_chart, 'duration': '3 min 45 s'},
    {'title': 'La santé enfantine', 'icon': Icons.family_restroom, 'duration': '3 min 45 s'},
    {'title': 'Eviter la mal nutrition enfantine', 'icon': Icons.pregnant_woman, 'duration': '3 min 45 s'},
    {'title': 'Consiegne pour enfant malade', 'icon': Icons.people_alt, 'duration': '3 min 45 s'},
    {'title': 'Droits à la protection', 'icon': Icons.security, 'duration': '3 min 45 s'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 1. AppBar personnalisée (Titre: Droits des enfants)
      appBar: AppBar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // NOTE: Le texte de bienvenue est le même que celui des Droits des femmes, 
                  // vous voudrez peut-être le modifier à l'avenir.
                  _buildIntroPanel(),
